...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app = FastAPI(
        ...
        contact={
            ...
            "email": str(resolved.admin_email or resolved.owner_email),
        },
        license_info={"name": "Proprietary"},
        openapi_tags=[
            {"name": "Health", "description": "Liveness and readiness probes"},
            {"name": "Authentication", "description": "Email/password authentication with JWT"},
            ...
            {"name": "Admin Catalog", "description": "Chef menu management"},
            ...
            {"name": "Kitchen Dashboard", "description": "Chef kitchen order boards and status actions"},
            {"name": "Admin Orders", "description": "Chef order management"},
            {"name": "Admin Email", "description": "Chef transactional email testing"},
            {"name": "Admin Dashboard", "description": "Chef dashboard stats, analytics, and charts"},
            {"name": "Admin Customers", "description": "Chef customer list and profile management"},
            {"name": "Admin Coupons", "description": "Chef coupon CRUD and usage reports"},
            {"name": "Admin Notifications", "description": "Chef notification create and broadcast"},
            {"name": "Admin Settings", "description": "Restaurant and system settings"},
            {"name": "Admin Audit", "description": "Chef audit log browsing"},
            {"name": "Admin Search", "description": "Chef console multi-entity search"},
        ],
    )
